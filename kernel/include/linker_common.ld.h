...
#define TEXT_FREE_AFTER_INIT \
    . = ALIGN(PAGE_SIZE); \
    SECTION_MARKER_BEGIN(FREE_AFTER_INIT_TEXT_SECTION) = .; \
...
#define RODATA_FREE_AFTER_INIT \
    . = ALIGN(PAGE_SIZE); \
    SECTION_MARKER_BEGIN(FREE_AFTER_INIT_RODATA_SECTION) = .; \
...
#define DATA_FREE_AFTER_INIT \
    . = ALIGN(PAGE_SIZE); \
    SECTION_MARKER_BEGIN(FREE_AFTER_INIT_DATA_SECTION) = .; \
    MARKED_SECTION(PER_CPU_SECTION) \
    *(.FREE_AFTER_INIT_DATA_SECTION) \
    . = ALIGN(PAGE_SIZE); \
    SECTION_MARKER_END(FREE_AFTER_INIT_DATA_SECTION) = .;
