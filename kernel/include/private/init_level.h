...
#define INIT_LEVELS \
    ...
    /* The kernel memory map covers all RAM ranges */ \
    INIT_LEVEL(MEMORY_MAP_AVAILABLE) \
    ARCH_INIT_LEVELS_AFTER_MEMORY_MAP_AVAILABLE \
    ...
    /*
     * The interrupt subsystem is operational: every resolver's
     * instance table is complete and interrupts may be requested
     */ \
    INIT_LEVEL(IRQS_AVAILABLE) \
    ARCH_INIT_LEVELS_AFTER_IRQS_AVAILABLE \
...
#ifndef ARCH_INIT_LEVELS_AFTER_MEMORY_MAP_AVAILABLE
#define ARCH_INIT_LEVELS_AFTER_MEMORY_MAP_AVAILABLE
#endif
...
#ifndef ARCH_INIT_LEVELS_AFTER_IRQS_AVAILABLE
#define ARCH_INIT_LEVELS_AFTER_IRQS_AVAILABLE
#endif
