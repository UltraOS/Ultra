...
/*
 * Don't edit these since they are part of the Linux ABI!
 *
 * These should be compatible with all architectures aside from DEC Alpha,
 * PowerPC, PA-RISC, MIPS and SPARC (all of which we will never support).
 *
 * (Numbers acquired from `errno --list`)
 */
#define EPERM 1
#define ENOENT 2
#define ESRCH 3
