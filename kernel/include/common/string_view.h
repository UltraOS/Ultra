...
ssize_t sv_find(struct string_view str, struct string_view needle,
                size_t starting_at);
...
static inline bool sv_contains(struct string_view str,
                               struct string_view needle)
{
...
static inline void sv_terminated_copy(char *dst, struct string_view str)
{
